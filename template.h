...
public:
	...
	vec4(): cell{}, x(0), y(0), z(0), w(0), xyz(), w2(0)
	{
	}

	vec4( float v ) : x( v ), y( v ), z( v ), w( v ) , w2(0) {}
	vec4( float x, float y, float z, float w ) : x( x ), y( y ), z( z ), w( w ) , w2(0) {}
	vec4( vec3 a, float b ) : x( a.x ), y( a.y ), z( a.z ), w( b ) , w2(0) {}
...
public:
	...
	uint4(): cell{}, x(0), y(0), z(0), w(0)
	{
	}

	uint4(int v) : x(v), y(v), z(v), w(v), cell{} {}
...
public:
	...
	int4(): cell{}, x(0), y(0), z(0), w(0)
	{
	}

	int4(int v) : x(v), y(v), z(v), w(v), cell{} {}
	int4(int x, int y, int z, int w) : x(x), y(y), z(z), w(w), cell{} {}
